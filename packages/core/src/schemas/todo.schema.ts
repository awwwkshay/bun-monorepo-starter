...
export const todoInsertSchema = createInsertSchema(todoModel).omit({ id: true, createdAt: true, updatedAt: true });

export type ITodoInsert = z.infer<typeof todoInsertSchema>;

export const todoUpdateSchema = createUpdateSchema(todoModel).omit({ id: true, createdAt: true, updatedAt: true });
